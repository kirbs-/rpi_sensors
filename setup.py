...
setup(
    ...
    description='A collection of Raspberry Pi sensor drivers.',
    # long_description=long_description,

    # The project's main homepage.
    url='https://github.com/kirbs-/rpi_sensors',
    ...
    keywords='raspberry pi sensors',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    # packages=find_packages(exclude=['contrib', 'docs', 'tests*']),
    packages={'rpi_sensors'}, install_requires=['dotmap', 'pyyaml']

    # List run-time dependencies here.  These will be installed by pip when
    # your project is installed. For an analysis of "install_requires" vs pip's
    # requirements files see:
    # https://packaging.python.org/en/latest/requirements.html
    # install_requires=['boto3', 'jupyterhub']
